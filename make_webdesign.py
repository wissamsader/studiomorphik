...
body{{background:var(--bg);color:var(--fg);font-family:'Montserrat',system-ui,-apple-system,'Segoe UI',Roboto,Helvetica,Arial,sans-serif;line-height:1.6;letter-spacing:.01em;-webkit-font-smoothing:antialiased}}
...
@media(max-width:520px){{.grid{{grid-template-columns:repeat(2,1fr)}}.card .meta{{flex-direction:column;align-items:flex-start;gap:2px}}}}
